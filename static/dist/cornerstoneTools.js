/*! cornerstone-tools - 2.3.7 - 2020-01-07 | (c) 2017 Chris Hafey | https://github.com/cornerstonejs/cornerstoneTools */
...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "a2b44546b56e714a263d";
...
function minimalStrategy(eventData) {
  ...
  (0, _drawing.draw)(context, function (context) {
    ...
    (0, _drawing.path)(context, { color: color }, function (context) {
...
var eraser = (0, _simpleMouseButtonTool2.default)(deleteNearbyMeasurement, toolType);
...
function pointNearHandle(eventData, toolIndex) {
  ...
  for (var i = 0; i < data.handles.length; i++) {
    ...
    if (_externalModules2.default.cornerstoneMath.point.distance(handleCanvas, mousePoint) < config.spacing) {
      return i;
    }
  }
...
function onImageRendered(e) {
  ...
  (0, _drawing.draw)(context, function (context) {
    ...
    (0, _drawing.path)(context, { color: color,
      lineWidth: lineWidth,
      lineDash: lineDash }, function (context) {
